...
*/}}
{{- define "dronescheduler.fullname" -}}
...
Common labels
*/}}
{{- define "dronescheduler.labels" -}}
helm.sh/chart: {{ include "dronescheduler.chart" . }}
{{ include "dronescheduler.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "dronescheduler.selectorLabels" -}}
